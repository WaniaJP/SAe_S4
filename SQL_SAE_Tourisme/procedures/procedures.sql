...
delimiter $
CREATE PROCEDURE addUtilisateur(Nom_ VARCHAR(50), Prenom_ VARCHAR(50), Naissance_ VARCHAR(10), mdp_ VARCHAR(50), email_ VARCHAR(50), Ville_ VARCHAR(100), Telephone_ CHAR(14))
BEGIN
   INSERT INTO utilisateur (Administre, Nom, Prenom, Naissance,  Ville, Telephone, mdp) VALUES (NULL, Nom_, Prenom_, Naissance_, Ville_, Telephone_, mdp_);
END $
